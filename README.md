...
- [x] App uses a TextView to say "Your tweet is too long" or "Your tweet can't be empty" instead of toasts
- [x] When tweeting, the tweet button and character count change color depending on if the tweet is valid or not
